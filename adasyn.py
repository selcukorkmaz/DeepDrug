...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 12:52:46 2019
...
resamplePathX = '/Volumes/selcuk/DeepDrug/resample/'+aid+'/ADASYN/X_resample_adasyn.txt'
resamplePathY = '/Volumes/selcuk/DeepDrug/resample/'+aid+'/ADASYN/y_resample_adasyn.txt'
...
plt.legend(['train', 'val'], loc='upper left')
plt.show()
#pathFig = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/adasyn.png'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/adasyn_train.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/adasyn_val.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/adasyn_test.txt'
