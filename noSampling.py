...
X_trainPath = '/Volumes/selcuk/DeepDrug/dataset/resample/'+aid+'/'+aid+'/X_train_raw.txt'
y_trainPath = '/Volumes/selcuk/DeepDrug/dataset/resample/'+aid+'/'+aid+'/y_train_raw.txt'
...
history = model.fit(X_train,y_train, batch_size=256, epochs=20, class_weight = class_weight, validation_data = (X_val, y_val))
...
pred = [1 if i >0.1 else 0 for i in y_pred]
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/raw_train.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/raw_val.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/raw_test.txt'
