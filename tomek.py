...
X_resample, y_resample = tl.fit_resample(X_train,y_train[:,0]) # performing Tomek's Link 
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/tomek_perf.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/tomek.txt'
