...
X_resample,y_resample = ros.fit_resample(X_train,y_train[:,0]) # performing ROS
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/ros_perf.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/ros.txt'
