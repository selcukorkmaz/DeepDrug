...
resamplePathX = '/Volumes/selcuk/DeepDrug/resample/'+aid+'/SMOTE/X_resample_smote.txt'
resamplePathY = '/Volumes/selcuk/DeepDrug/resample/'+aid+'/SMOTE/y_resample_smote.txt'
...
plt.legend(['train', 'val'], loc='upper left')
plt.show()
#pathFig = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smote.png'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smote_train.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smote_val.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smote_test.txt'
