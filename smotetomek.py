...
smt = SMOTETomek(random_state=123, n_jobs=-1)
X_resample, y_resample = smt.fit_resample(X_train,y_train[:,0]) # performing SMOTETomek 
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smotetomek_perf.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smotetomek.txt'
