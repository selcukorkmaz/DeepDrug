...
X_resample, y_resample = sme.fit_resample(X_train,y_train[:,0]) # performing SMOTEENN 
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smoteenn_perf.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/smoteenn.txt'
