...
X_resample, y_resample = enn.fit_resample(X_train,y_train[:,0]) # performing ENN 
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/enn_perf.txt'
...
path = '/Volumes/selcuk/DeepDrug/Classification Results/'+aid+'/enn.txt'
